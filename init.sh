...
echo -e "> Please make sure \033[1m\033[31mPython3.10\033[0m and Python library \033[1m\033[31mpsycopg2\033[0m is installed on local machine, they are used to upload init data to database."
echo ""
